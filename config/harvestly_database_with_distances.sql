...
('delivery_confirmation_timeout_hours', '48', 'INTEGER', 'Auto-completion timeout after Delivered if no unresolved complaint blocks completion.'),
('buyer_dispute_window_hours', '24', 'INTEGER', 'Buyer complaint/dispute window after delivery.'),
