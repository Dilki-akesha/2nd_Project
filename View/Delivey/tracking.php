    ...
    <div>
        ...
        <div class="table-wrap">
            <div class="live-location">
                <i class="fas fa-map-marked-alt" style="color:var(--md-primary);"></i>
                <strong>Live Location</strong>
                <div class="map-placeholder">
                    <i class="fas fa-map"></i> <span>Map Integration</span>
                </div>
                <div class="buyer-info">
                    <strong>Whole Foods Market</strong><br>
                    Sarah Thompson<br>
                    <span class="text-muted">3410 Arden Way, Sacramento</span>
                </div>
            </div>
        </div>
    </div>
